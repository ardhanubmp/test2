                    ...
                    <tbody>
                      <?php foreach ($arr_penduduk as $penduduk): ?>
                        <tr>
                            ...
                            <td>
                              <a href="<?php echo base_url('/admin/penduduk/edit_detail/'.$penduduk->id); ?>">edit</a>
                              <a href="<?php echo base_url('/admin/penduduk/lihat/'.$penduduk->id); ?>">lihat</a>
                              <button class="btn btn-danger" data-target="#deleteModal" data-toggle="modal" data-link="<?php echo base_url('admin/penduduk/hapus/'.$penduduk->id); ?>"><i class="fa fa-trash" ></i>Hapus</button>
                            </td>
                        </tr>
                      <?php endforeach ?>
                    </tbody>
                          ...
                          <div class="box-body">
                            ...
                            <!-- <form class="form-horizontal"> -->
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-md-9">
                                  <input name="nik" type="text" class="form-control" placeholder="1 = kepala keluarga"></input>
                                </div>
                              </div>
                              <div class="form-group">
