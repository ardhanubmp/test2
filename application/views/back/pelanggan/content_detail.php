                ...
                <div class="box-body">
                  ...
                  <!-- <form class="form-horizontal"> -->
                    <div class="form-group">
                      ...
                      <div class="col-lg-9">
                        <input name="nama_lengkap" type="text" class="form-control" value="<?php echo $pelanggan->nama_lengkap; ?>"></input>  
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-lg-3">Username</label>
                      <div class="col-lg-9">
                        <input name="username" type="text" class="form-control" value="<?php echo $pelanggan->username; ?>"></input>  
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-lg-3">Email</label>
                      <div class="col-lg-9">
                        <input name="email" type="email" class="form-control" value="<?php echo $pelanggan->email; ?>"></input>  
                      </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-lg-9">
                        <input name="no_hp" type="text" class="form-control" value="<?php echo $pelanggan->no_hp; ?>"></input>  
                      </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-lg-9">
                        <?php if ($pelanggan->jenis_kelamin=='laki-laki'): ?>
                          <input name="jenis_kelamin" type="radio" value="laki-laki" checked=""> laki - laki</input>  
                        ...
                        <?php else: ?>
                          ...
                          <input name="jenis_kelamin" type="radio" value="perempuan" checked=""> perempuan</input>  
                        <?php endif ?>
                      </div>
                    </div>
                    <div class="form-group">
