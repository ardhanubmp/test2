              ...
              <div class="modal-dialog modal-sm" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <?php echo form_open_multipart('admin/ornamen/tambah',array('class'=>'form-horizontal')); ?>
                    <!-- <form class="form-horizontal"> -->
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-10">
                          <input name="type" id="typeAdd"></input>
            ...
            <div class="modal fade" id="editOrnamen" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
              <div class="modal-dialog modal-sm" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <?php echo form_open_multipart('admin/ornamen/ubah',array('class'=>'form-horizontal')); ?>
                    <!-- <form class="form-horizontal"> -->
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-10">
                          ...
                          <input name="type" type="text" id="typeUpdate"></input>
                          <input name="gambar_temp" type="text" id="gambarTempUpdate"></input>
                          <input name="gambar" type="file" class="form-control"></input>
                        </div>
                      </div>
