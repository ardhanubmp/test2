                    ...
                    <tbody>
                      <?php foreach ($arr_pengiriman as $pengiriman): ?>
                        <tr>
                            ...
                            <td>
                              <button class="btn btn-primary" data-target="#editModal" data-toggle="modal" data-id="<?php echo $pengiriman->id_kota; ?>"><i class="fa fa-edit" ></i>Edit</button>
                              <button class="btn btn-danger" data-target="#deleteModal" data-toggle="modal" data-link="pengiriman/delete/<?php echo $pengiriman->id_kota; ?>"><i class="fa fa-trash" ></i>Hapus</button>
                            </td>
                        </tr>
                      <?php endforeach ?>
                    </tbody>
                  ...
                  <div class="modal-body">
                    <form class="form-horizontal">
                      <div class="form-group">
                        ...
                        <div class="col-md-10">
                          <input name="nama_kota" type="text" class="form-control"></input>
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-2">Tarif</label>
                        <div class="col-md-10">
                          <input name="tarif" type="text" class="form-control"></input>
                        </div>
                      </div>
                  </div>
                  <div class="modal-footer">
                    <input name="id" type="text" id="idUpdate"></input>
