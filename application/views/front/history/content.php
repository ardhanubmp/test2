            ...
            <div class="col-md-12">
              <div class="panel panel-success">
                  ...
                  <div class="panel-body">Segera lakukan Tranfer ke salah satu rekening berikut sesuai dengan <strong>Total bayar</strong> dibawah:
                      ...
                      Lalu segera lakukan <a href="<?php echo base_url(); ?>member/konfirmasi" target="_blank">konfirmasi</a> agar pemesanan cepat diproses. Terimakasih
                  </div>
              </div>              
            </div>
          </div>          
                    ...
                    <?php if (!empty($arr_transaksi)): ?>
                      <?php foreach ($arr_transaksi as $transaksi): ?>
                        <tr>
                            ...
                            <td>
                              <?php if ($transaksi->status == 'pending'): ?>
                              <a href="<?php echo base_url(); ?>member/konfirmasi" class="btn btn-rounded btn-red" title="Hapus"><i class="fa fa-pencil-square-o "></i>Konfirmasi</a>
                              <?php endif ?>
                              <a href="<?php echo base_url('member/history/detail/'.$transaksi->id_transaksi); ?>" class="btn btn-rounded btn-green" title="Lihat"><i class="fa fa-eye"></i>Lihat</a>
                            </td>
                        </tr>
                      <?php endforeach ?>
                    <?php endif ?>
